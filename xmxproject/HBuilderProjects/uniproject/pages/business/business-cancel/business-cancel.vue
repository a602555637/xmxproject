		...
		<view class="container-middle" >
			...
			<view class="total-content">
				...
				<view class="container-button">
					<view v-if="isCancel" @click="bindChangeStatus" class="button-left">取消确认</view>
					<view v-else class="button-left" @click="onIndex">回到首页</view>
